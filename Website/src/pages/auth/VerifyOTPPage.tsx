...
const VerifyOTPPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--th-bg)] relative overflow-hidden font-['Manrope'] transition-colors duration-300">
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-[var(--th-glow)] blur-[120px] rounded-full" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[var(--th-secondary)]/10 blur-[120px] rounded-full" />
      ...
      <div className="w-full max-w-md p-8 bg-[#031427]/60 backdrop-blur-2xl border border-white/5 rounded-3xl shadow-2xl z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-[var(--th-accent)] text-xs font-bold mt-2">{email}</p>
        </div>
        ...
        <form onSubmit={handleVerify} className="space-y-8">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[var(--th-accent)] text-[var(--th-accent-text)] font-bold font-['Space_Grotesk'] py-5 rounded-2xl active:scale-[0.98] transition-all shadow-[0_0_20px_color-mix(in srgb, var(--th-accent) 20%, transparent)] disabled:opacity-50 disabled:cursor-not-allowed uppercase tracking-widest"
          >
