...
// export default function AidaPage() {
//   const defaultGreeting = { role: "assistant", content: "Greetings, voyager. I am Aida, your luminous guide through the Sets universe. How can I assist your journey today?" };
  
//   const [messages, setMessages] = useState<any[]>(() => {
//     const saved = sessionStorage.getItem('aida_messages');
//     if (saved) {
//       try {
...
//   useEffect(() => {
//     sessionStorage.setItem('aida_messages', JSON.stringify(messages));
//   }, [messages]);
